...
--insert query---
insert into ticketheader values(4520,'10-Dec-2021','4-Dec-2021','raj-jam',501);
insert into ticketheader values(3520,'6-Dec-2021','2-Dec-2021','ahk-raj',552);
insert into ticketheader values(520,'5-Dec-2021','1-Dec-2021','mum-jamu',51);
insert into ticketheader values(50,'5-Dec-2021','1-Dec-2021','mum-jamu',51);
insert into ticketheader values(420,'7-Dec-2021','3-Dec-2021','goa-sur',405);
insert into ticketheader values(894,'9-Dec-2021','5-Dec-2021','amr-jam',123);

update ticketheader set boardplace='raj-jam' where ticketno=894;
update ticketheader set routeno=501 where ticketno=894;

insert into ticketheader values(894,'9-Dec-2021','5-Dec-2021','raj-jam',501);
---
update ticketheader set dateodtravel='1-Dec-2021' where ticketno=3520;
...
(
 ...
 --
 alter table ticket_details drop column fare;
